...
//               id="email"
//               name="email"
//               className="w-full px-3 py-2 border rounded-md text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary-500"
//               required
//             />
//           </div>
//           <div className="mb-6">
...
//           <button
//             type="submit"
//             className="w-full bg-primary hover:bg-primary-600 text-gray-700 font-bold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 transition duration-300 ease-in-out"
//           >
//             Log In
//           </button>
//         </form>
